                    ...
                    <div className='flex flex-row '>
                        ...
                        <div className='w-[300px] h-[300px]'>
                            ...
                            <div className='absolute w-[300px] h-[300px]'>
                                ...
                                <div className='absolute top-[120px] left-[100px] text-[50px] font-semibold '>KM2</div>
                            </div>
                        </div>
                        ...
                        <div className='w-[300px] h-[300px]'>
                            {/**ข้างในชื่อสาขา */}
                            <div className='absolute md:top-[500px] top-[600px] w-[300px] h-[300px]'>
                    ...
                    <div className='flex md:flex-row mt-[30px] flex-col'>
                        ...
                        <div className='md:mr-[140px] flex flex-col items-center'>
                            ...
                            <div className='mb-[40px] w-[300px] h-[400px]'>
                                ...
                                <div className='w-[300px] h-[400px] shadow-[10px_10px_rgba(0,0,0,0.2)] hover:shadow-[10px_10px_30px_rgb(229,242,5)]'>
                                    <img className='bg-cover' src='gl1.jpg'></img>
                                </div>
                            </div>
                            ...
                            <button
                                className='mb-[40px] w-[300px] h-[60px] bg-none border-black border-[2px] rounded-[30px] hover:bg-black hover:opacity-25 hover:text-white hover:border-white'
                                onClick={() => handleArtistClick('น้ำตาลฟิล์ม')} // Pass artist name on click
                            >น้ำตาลฟิล์ม</button>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <div className='mb-[40px] w-[300px] h-[400px]'>
                                ...
                                <div className='w-[300px] h-[400px] shadow-[10px_10px_rgba(0,0,0,0.2)] hover:shadow-[10px_10px_30px_rgb(229,242,5)]'>
                                    <img className='bg-cover' src='gl2.jpg'></img>
                                </div>
                            </div>
                            ...
                            <button
                                className='mb-[40px] w-[300px] h-[60px] bg-none border-black border-[2px] rounded-[30px] hover:bg-black hover:opacity-25 hover:text-white hover:border-white'
                                onClick={() => handleArtistClick('ฟรีนเบคกี้')}>ฟรีนเบคกี้</button>
                    ...
                    <div className='flex md:flex-row flex-col'>
                        ...
                        <div className='md:mr-[140px] flex flex-col items-center'>
                            ...
                            <div className='mb-[40px] w-[300px] h-[400px]'>
                                ...
                                <div className='w-[300px] h-[400px] shadow-[10px_10px_rgba(0,0,0,0.2)] hover:shadow-[10px_10px_30px_rgb(229,242,5)]'>
                                    <img className='bg-cover' src='gl3.jpg'></img>
                                </div>
                            </div>
                            ...
                            <button
                                className='mb-[40px] w-[300px] h-[60px] bg-none border-black border-[2px] rounded-[30px] hover:bg-black hover:opacity-25 hover:text-white hover:border-white'
                                onClick={() => handleArtistClick('หลิงออม')} // Pass artist name on click
                            >หลิงออม</button>
                        ...
                        <div className='flex flex-col items-center'>
                            ...
                            <div className='mb-[40px] w-[300px] h-[400px]'>
                                ...
                                <div className='w-[300px] h-[400px] shadow-[10px_10px_rgba(0,0,0,0.2)] hover:shadow-[10px_10px_30px_rgb(229,242,5)]'>
                                    <img className='bg-cover' src='gl4.jpg'></img>
                                </div>
                            </div>
                            ...
                            {/** ปุ่ม ผู้เข้าชิงคนที่ 4 */}
                                ...
                                <button
                                    className='w-[300px] h-[60px] bg-none border-black border-[2px] rounded-[30px] hover:bg-black hover:opacity-25 hover:text-white hover:border-white'
                                    onClick={() => handleArtistClick('มิลค์เลิฟ')} // Pass artist name on click
                                    >มิลค์เลิฟ</button>
