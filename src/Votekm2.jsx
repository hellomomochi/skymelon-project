...
function Vote() {
    ...
    const [voteCount, setVoteCount] = useState(1); // เริ่มต้น voteCount state ด้วย 1
            ...
            <div className='absolute w-full md:h-[1820px] h-[2900px]'>
                <div className='flex flex-col items-center'>
                    ...
                    <div className='mt-[100px] bg-[#ff5b56] h-[500px] md:w-[550px] w-[470] md:rounded-[30px] rounded-[20px] shadow-[4px_4px_rgba(0,0,0,0.6)] flex flex-col items-center bg-opacity-[80%]'>
                        ...
                        <input value='คู่จิ้นหญิงยอดนิยม' className='mt-[3px] w-[200px] h-[40px] bg-white outline-none px-[15px] hover:outline-[#6B201E] rounded-[20px] shadow-[3px_4px_rgba(0,0,0,0.5)]'></input>
